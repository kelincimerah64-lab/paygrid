...
class PayGridRoutingTest extends TestCase
{
    ...
    public function test_ma_analytics_page_computes_settlement_reconciliation(): void
    {
        ...
        $merchant = Merchant::query()->create([
            ...
            'merchant_type' => 'cm',
            'gateway' => 'hilogate',
            'merchant_id' => 'settlement-test-hg-id',
            'merchant_key' => 'settlement-test-hg-secret',
            'approval_status' => 'approved',
        ]);
        ...
        MerchantSettlement::query()->create([
            ...
            'gateway_merchant_id' => $merchant->merchant_id, 'reference' => 'SETTLE-TEST-001',
        ...
        $response = $this->actingAs($ma)->get('/ma/analytics?period=all')->assertOk();
        $response->assertSee('Settlement Test Store');
