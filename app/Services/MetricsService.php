...
class MetricsService
{
    ...
    public function agentMerchants(Agent $agent, mixed $from = null, mixed $to = null): Collection
    {
        return Merchant::query()
            ...
            ->withSum(['metrics as metric_amount_pending' => fn (Builder $query) => $this->metricRange($query, $from, $to)], 'amount_pending')
            ->withSum(['metrics as metric_settlement' => fn (Builder $query) => $this->metricRange($query, $from, $to)], 'settled_total')
