...
@if($active === 'fee')
    ...
    <section class="card qris-panel section"><div class="qris-toolbar"><div><h2>Pembagian Fee Per Toko</h2><p class="muted" style="margin:4px 0 0">Status <strong>Gak Sinkron</strong> artinya total MA Fee &amp; Agen Fee gak sama dengan Merchant MDR toko itu &mdash; rate Agent/MA perlu disesuaikan biar MDR Merchant = MA Fee + Agen Fee.</p></div></div><table class="table qris-table ma-fee-split-table"><thead><tr><th>Toko</th><th>Menu Fee</th><th>Merchant MDR</th><th>Estimasi MDR Toko</th><th>Estimasi Fee Agen</th><th>MA Fee &amp; Agen Fee</th><th>Estimasi Fee MA</th><th>Status</th><th>Detail</th></tr></thead><tbody>
    @foreach($merchants as $m)
    @php
        $combinedPercent = (float) $m->agent_fee_percent + (float) $m->ma_fee_percent;
