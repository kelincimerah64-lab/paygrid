...
<section class="card qris-panel section">
    ...
    <div class="table-wrap">
        <table class="table qris-table agent-fee-table">
            <thead><tr><th>Toko</th><th>Kode Merchant</th><th>TRX Sukses</th><th>Volume Sukses</th><th>MDR Toko</th><th>Estimasi MDR Toko</th><th>Margin Fee Agen</th><th>Estimasi Fee Agen</th><th>Detail</th></tr></thead>
            <tbody>
            @forelse($rows as $row)
                <tr>
